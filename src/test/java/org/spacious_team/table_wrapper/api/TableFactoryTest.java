...
class TableFactoryTest {
    ...
    @Test
    void create1() {
        when(reportPage.getCellRange(tableName, lastRowString, 0, 1)).thenReturn(tableCellRange);
    ...
    @Test
    void create2() {
        when(reportPage.getCellRange(tableName, 0, 1)).thenReturn(tableCellRange);
